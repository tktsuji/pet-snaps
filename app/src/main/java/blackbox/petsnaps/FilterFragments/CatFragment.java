...
public class CatFragment extends BaseFilterFragment {
    ...
    public void onStart() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Long, PostItemViewHolder>(
                Long.class,
                R.layout.post_item,
                PostItemViewHolder.class, catRef.orderByValue().limitToLast(64)) {
            @Override
