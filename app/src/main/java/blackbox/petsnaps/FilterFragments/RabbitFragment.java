...
public class RabbitFragment extends BaseFilterFragment {
    ...
    public void onStart() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Long, PostItemViewHolder>(
                Long.class,
                R.layout.post_item,
                PostItemViewHolder.class, rabbitRef.orderByValue().limitToLast(64)) {
            @Override
    ...
    public void onDestroy() {
        ...
        Log.d("RABBITFRAGMENT", "ON DESTROY");
    }
}